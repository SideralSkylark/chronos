...
/**
 * Binds a {@link Subject} to a specific @{link Cohort} with a {@link UserRole.TEACHER} Represents
 * an instance of a lesson to be lectured
 */
@Entity
@Table(
    name = "cohort_subjects",
    uniqueConstraints = {
