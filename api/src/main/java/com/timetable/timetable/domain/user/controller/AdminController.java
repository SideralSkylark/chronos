 ...
 *
 * <p>Provides endpoints for creating, updating, deleting, and listing users. Access is restricted
 * to users with ADMIN, ASISTENT, or DIRECTOR roles.
 *
...
public class AdminController {
  ...
  public ResponseEntity<ApiResponse<UserResponse>> createUser(
    ...
    return ResponseFactory.ok(
        userService.createUserResponse(createUser), "User created sucessfully.");
  }
  ...
  public ResponseEntity<ApiResponse<PagedModel<UserResponse>>> getUsers(
    ...
    return ResponseFactory.ok(
        new PagedModel<>(userService.getAllUsers(pageable, filter)), "Users fetched sucessfully.");
  }
  ...
  public ResponseEntity<ApiResponse<UserResponse>> getUserById(@PathVariable Long id) {
    return ResponseFactory.ok(userService.getUserById(id), "User fetched sucessfully.");
  }
  ...
  public ResponseEntity<ApiResponse<UserResponse>> updateUser(
      @PathVariable Long id, @RequestBody AdminUpdateUserDTO updateRequest) {
    return ResponseFactory.ok(
        userService.updateUserById(id, updateRequest), "User updated sucessfully.");
  }
  ...
  public ResponseEntity<ApiResponse<ResetPasswordResponse>> resetPassword(@PathVariable Long id) {
    return ResponseFactory.ok(userService.resetPassword(id), "User password reset successfully.");
  }
