...
public record CreateCohortSubjectRequest(
  ...
  public static CreateCohortSubjectRequest from(
      Long cohortId, Long subjectId, Long assignedTeacherId) {
    return new CreateCohortSubjectRequest(cohortId, subjectId, assignedTeacherId);
  }
}
