...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleValidationException(
    ...
    log.warn(
        "Validation failed for {} {}: {}", request.getMethod(), request.getRequestURI(), errors);
  ...
  public ResponseEntity<ErrorResponse> handleInvalidCredentials(
    ...
    log.warn(
        "Auth failure on {} {}: {}", request.getMethod(), request.getRequestURI(), ex.getMessage());
  ...
  public ResponseEntity<ErrorResponse> handleTokenError(
    ...
    log.warn(
        "Token error on {} {}: {}", request.getMethod(), request.getRequestURI(), ex.getMessage());
    return ResponseFactory.error(HttpStatus.BAD_REQUEST, ex.getMessage(), request);
  }
  ...
  public ResponseEntity<ErrorResponse> handleUserNotAuthorized(
    ...
    log.warn(
        "Unauthorized on {} {}: {}", request.getMethod(), request.getRequestURI(), ex.getMessage());
    return ResponseFactory.error(HttpStatus.UNAUTHORIZED, ex.getMessage(), request);
  }
  ...
  public ResponseEntity<ErrorResponse> handleNoHandlerFound(
    ...
    return ResponseFactory.error(
        HttpStatus.NOT_FOUND, "The requested resource was not found", request);
  }
  ...
  public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
    ...
    return ResponseFactory.error(
        HttpStatus.CONFLICT, "A resource with conflicting data already exists", request);
  }
  ...
  public ResponseEntity<ErrorResponse> handleConstraintViolation(
    ...
    return ResponseFactory.error(
        HttpStatus.BAD_REQUEST, "Request violates a data constraint", request);
  }
