 ...
 *
 * <p>The {@code ResponseFactory} provides convenient methods for returning success and error
 * responses wrapped in custom DTOs such as {@link ApiResponse}, {@link MessageResponse}, and {@link
 * ErrorResponse}. This promotes consistent response formatting, reduces boilerplate, and improves
 * maintainability.
 *
