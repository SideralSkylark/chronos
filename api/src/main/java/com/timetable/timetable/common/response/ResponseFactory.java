...
/**
 * Utility class for constructing standardized HTTP responses used across the
 * application.
 * <p>
 * The {@code ResponseFactory} provides convenient methods for returning success
 * and error responses
 * wrapped in custom DTOs such as {@link ApiResponse}, {@link MessageResponse},
 * and {@link ErrorResponse}.
 * This promotes consistent response formatting, reduces boilerplate, and
...
public class ResponseFactory {
    ...
    /**
     * Returns an error response with the specified status, message, and request
     * URI.
     *
    ...
    /**
     * Returns an error response with the specified status, message, and path
     * string.
     *
    ...
    /**
     * Returns a generic 500 Internal Server Error with a fallback message and
     * request URI.
     *
